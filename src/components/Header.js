                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
                    <Link to="/" className="flex items-center">
                        <img
                            ...
                            alt="Flowbite Logo"
                        />
                        <span className="self-center text-sm font-semibold underline whitespace-nowrap decoration-blue-400 decoration-4 underline-offset-4">
                            SKYLANG
                        </span>
                    </Link>
                        ...
                        <ul className="flex flex-row items-center mt-0 space-x-5 font-medium">
                            {userLoggedIn ? (
                                <>
                                    ...
                                    <li>
                                        <button
                                            className="px-3 py-1 text-white duration-300 bg-blue-600 rounded-xl hover:bg-blue-700 hover:shadow-xl"
                                            onClick={() => {
                                                doSignOut().then(() => {
                                                    navigate('/');
                                                });
                                ...
                                <>
                                    <li>
                                        <Link
                                            className="px-3 py-2 text-white duration-300 bg-blue-600 rounded-lg hover:bg-blue-700 hover:shadow-xl"
                                            to="login"
                                        >
                                            Sign in
                                        </Link>
